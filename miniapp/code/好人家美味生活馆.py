...
class AutoTask:
    ...
    def wxlogin(self, session, code):
        ...
        try:
            ...
            payload = {"appid":self.wx_appid,"basicInfo":{"bosId":"4021565647273","cid":"505934273","tcode":"weimob","vid":"6015869513273"},"env":"production","extendInfo":{"source":1},"is_pre_fetch_open":"true","parentVid":0,"pid":"","storeId":"","code":code,"queryAuthConfig":"true"}
            response = session.post(url, json=payload, timeout=5)
