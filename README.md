...
| [宠胖胖](https://ch.mewpet.cn/2vPn) |    ✅️     | 签到、做部分任务、领取在线和任务奖励、查询积分 |  cpp_token  | chongpangpang.com请求下的**Authorization**或**token**值 |                                                              |

## 支持小程序

|                      名称                       | 是否有效 |                       功能                       |      变量      |                        变量说明                         |                        特殊说明                        |
| :---------------------------------------------: | :------: | :----------------------------------------------: | :------------: | :-----------------------------------------------------: | :----------------------------------------------------: |
|                     回收猿                      |    ✅️     |                    签到、抽奖                    |  hsy_username  |        www.52bjy.com 请求url参数中的**username**        |                         不过期                         |
...
|   [老板服务微商城 ](https://a.c1ns.cn/OIFBt)    |    ✅️     |             签到、做部分任务、查积分             | lbfwwsc_openid |         vip.foxech.com域名请求中的**openid**值          |                         不过期                         |
| [所有女生会员服务中心](https://a.c1ns.cn/2cVCq) |    ✅️     |            签到、浏览、预约、查询积分            |   syns_token   |           7.wawo.cc域名请求中的Accesstoken值            |                                                        |
...
| [所有女生会员服务中心](https://a.c1ns.cn/2cVCq) | ✅️ | 签到、浏览、预约、查询积分 | |
| [玛氏宠享会](https://a.c1ns.cn/9e0Lb) | ✅️ | 签到、分享、查询积分 | 进入后授权点击更新昵称 |
